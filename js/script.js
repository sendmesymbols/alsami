...
function fixFooterPaths(isRootPage, isNestedPage) {
    ...
    const paths = {
        root: {
            ...
            projects: 'pages/projects.html',
            contact: 'pages/contact.html',
            'services-construction': 'pages/construction-renovation.html',
            'services-roofing': 'pages/roofing-protective-solutions.html',
            'services-interior': 'pages/interior-finishing-flooring.html',
            'services-partition': 'pages/partition-glass-work.html',
            'services-plumbing': 'pages/plumbing-sanitary-services.html',
            'services-electrical': 'pages/electrical-mechanical-works.html',
